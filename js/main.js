(function () {
  ...
  const translations = {
    ru: {
      ...
      'screens.card4.text': 'Удобно выбирайте нужные наборы слов — по частям речи, темам и уровню.',
    ...
    uk: {
      ...
      'screens.card4.text': 'Зручно обирайте потрібні набори слів — за частинами мови, темами та рівнем.',
