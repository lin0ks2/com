(function () {
  ...
  const translations = {
    ru: {
      ...
      'hero.title': 'Ваш личный тренажер слов в телефоне',
      ...
      'hero.ctaPrimary': 'Запустить',
      'hero.ctaSecondary': 'Как это работает',
      'hero.note': '* Тренажёр откроется как веб-приложение.',
      ...
      'screens.lead': '<span class="brand-word">MOYAMOVA</span> спроектирован в первую очередь как мобильный тренажёр без рекламы и платных подписок. Только Вы, новые слова и Ваш прогресс',
      'screens.themes.text': 'Адаптивный интерфейс. Тренажёр автоматически подстраивается под системные настройки.',
      ...
      'screens.card3.text': 'Можно отдельно повторять сложные слова или держать компактный набор избранных.',
      ...
      'screens.card4.text': 'Удобные фильтры, полезные примеры к изучаемым словам, озвучка и другие опции для тренировок.',
    ...
    uk: {
      ...
      'hero.currentLang': 'Вчіть німецьку безкоштовно прямо зараз!',
      'hero.ctaPrimary': 'Запустити',
      'hero.ctaSecondary': 'Як це працює',
      'hero.note': '* Тренажер відкриється як веб-додаток.',
      ...
      'screens.lead': '<span class="brand-word">MOYAMOVA</span> спроектовано в першу чергу як мобільний тренажер без реклами і платних підписок. Лише Ви, нові слова та Ваш прогрес',
      'screens.themes.text': 'Адаптивний інтерфейс. Тренажер автоматично підлаштовується під системні налаштування, а за бажання тему можна змінити вручну.',
      ...
      'support.text': 'Якщо вам подобається наш застосунок — ви можете підтримати розвиток проєкту. Це допомагає нам розвивати тренажер і додавати нові функції.',
      'support.go': 'Перейти до підтримки',
      'screens.card4.text': 'Зручні фільтри, живі приклади до слів, озвучка та інші опції для тренувань.',
