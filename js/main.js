(function () {
  ...
  const translations = {
    ru: {
      ...
      'hero.currentLang': 'Сейчас основной язык — немецкий (DE)',
      ...
      'who.title': 'Кому подойдёт <span class="brand-word">MOYAMOVA</span>',
      ...
      'screens.lead': '<span class="brand-word">MOYAMOVA</span> проектирован в первую очередь как мобильный тренажёр. Один экран — одна карточка — одно решение.',
      ...
      'support.title': 'Поддержать <span class="brand-word">MOYAMOVA</span>',
      'support.text': 'Если вам нравится <span class="brand-word">MOYAMOVA</span> — вы можете поддержать развитие проекта. Это помогает нам развивать тренажёр и добавлять новые функции.',
      'support.go': 'Перейти к поддержке',
      'screens.card4.text': 'Дополнительные функции <span class="brand-word">MOYAMOVA</span>: отдельные словари, примеры к словам, озвучка и другие опции для удобных тренировок.',
...
'reviews.title': 'Отзывы пользователей',
      ...
      'support.collab': '',
      'share.title': 'Поделиться <span class="brand-word">MOYAMOVA</span>:',
    ...
    uk: {
      ...
      'hero.currentLang': 'Зараз основна мова — німецька (DE)',
      ...
      'who.title': 'Кому підійде <span class="brand-word">MOYAMOVA</span>',
      ...
      'support.title': 'Підтримати <span class="brand-word">MOYAMOVA</span>',
      ...
      'screens.card4.text': 'Додаткові можливості <span class="brand-word">MOYAMOVA</span>: окремі словники, живі приклади до слів, озвучка та інші опції для зручних тренувань.',
