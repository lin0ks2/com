(function () {
  ...
  const translations = {
    ru: {
      ...
      'faq.q3.text': 'MOYAMOVA уже поддерживает 🇩🇪 немецкий, 🇬🇧 английский и 🇪🇸 испанский. Скоро добавим 🇫🇷 французский, 🇮🇹 итальянский и 🇵🇱 польский — следите за обновлениями!',
    ...
    uk: {
      ...
      'faq.q3.text': 'MOYAMOVA уже підтримує 🇩🇪 німецьку, 🇬🇧 англійську та 🇪🇸 іспанську. Невдовзі з’являться 🇫🇷 французька, 🇮🇹 італійська та 🇵🇱 польська — стежте за оновленнями!',
