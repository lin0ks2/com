(function () {
  ...
  const translations = {
    ...
    uk: {
      ...
      'faq.q1.text': 'Так, тренажер можна використовувати безкоштовно для некомерційного використання. У тренажері є платні функції, які підвищують зручність та ефективність навчання, але вони не є обов’язковими до придбання.',
