(function () {
  ...
  const translations = {
    ru: {
      ...
      'hero.currentLang': 'Учите немецкий прямо сейчас!',
      ...
      'screens.lead': '<span class="brand-word">MOYAMOVA</span> спроектирован в первую очередь как мобильный тренажёр. Один экран — одна карточка — одно решение.',
      ...
      'screens.card4.text': 'Дополнительные функции: отдельные словари, примеры к словам, озвучка и другие опции для удобных тренировок.',
